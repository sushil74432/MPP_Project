...
public class AddNewBookPanel {
	...
	private static JPanel getPanel(JFrame frame) {
		panel = new JPanel();
		panel.setBackground(ColorPalatte.BACKGROUND);
		frame.setBackground(ColorPalatte.BACKGROUND);
		...
		lblAddNewMember.setBackground(ColorPalatte.BACKGROUND);
...
//		AllIDsLabel.setBounds(42, 10, 319, 36);
		...
		bookPanel.setBorder(BorderFactory.createMatteBorder(1, 1, 1, 1, Color.GRAY));
		bookPanel.setBackground(ColorPalatte.BACKGROUND);
		...
		btnCancel.setBounds(860, 166, 102, 41);
		panel.add(btnCancel);

		JPanel authorPanel = new JPanel();
		authorPanel.setBackground(ColorPalatte.BACKGROUND);
		...
		btnCancelAuthor.setBounds(820, 226, 102, 41);
		...
		addressPanel.setBackground(ColorPalatte.BACKGROUND);
...
//		addressPanel.add(isExpert);
		...
		JLabel lblId_1_2_1_1_1 = new JLabel("Phone");
		...
		btnAddAuthor.addActionListener(e -> {
			...
			if (fN.equals("") || lN.equals("") || street.getText().equals("") || city.getText().equals("")
				...
				Author author = new Author(fN, lN, phone, address, "", true);
				authors.add(author);
	...
	private static void clearAuthorInputs() {
		firstName.setText("");
		lastName.setText("");
		street.setText("");
		city.setText("");
