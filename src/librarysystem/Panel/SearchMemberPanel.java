...
public class SearchMemberPanel extends JFrame {
	...
	SearchMemberPanel() {
		...
		middleNorth.setBackground(ColorPalatte.BACKGROUND);
		...
		middleWest.setBackground(ColorPalatte.BACKGROUND);
		...
		eastWest.setBackground(ColorPalatte.BACKGROUND);
...
//						.println("-----------------------------------------------------------------------------------");
				...
				System.out.println("");
				System.out.println("Member ID: " + txtMemberId.getText());
				System.out.println("");

				System.out.printf(
						"-----------------------------------------------------------------------------------%n");
				System.out.printf("| %-10s | %-20s | %11s | %13s | %13s |%n", "ISBN", "BOOK     ", "COPY ID    ",
