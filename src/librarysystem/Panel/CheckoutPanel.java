...
public class CheckoutPanel extends JFrame implements LibWindow {
	...
	public void init() {
		...
		checkoutPanel.setBackground(ColorPalatte.BACKGROUND);
	...
	private JTextField getLblAndTxt(JPanel parentPanel, String strLbl, boolean bEnable) {
		...
		textPanel.setBackground(ColorPalatte.BACKGROUND);
		FlowLayout flowLayout_1 = (FlowLayout) textPanel.getLayout();
